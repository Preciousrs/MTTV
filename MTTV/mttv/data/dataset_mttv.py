...
class JsonlDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        feature_file = os.path.join('/data/rensisi/HMCAN/MTTV/data/fakeddit/visual_feature/{}.pkl'.format(self.data[index]["id"]))
        ...
        feature_file = os.path.join('/data/rensisi/HMCAN/MTTV/data/fakeddit/region_feature/{}.pkl'.format(img_name))
        with open(feature_file, mode='rb') as f:
