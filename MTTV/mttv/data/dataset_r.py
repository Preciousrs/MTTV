...
class JsonlDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        feature_file = os.path.join('/data/rensisi/HMCAN/MTTV/data/gossip/visual_feature/{}.pkl'.format(self.data[index]["id"]))
        ...
        # img_name = self.data[index]["img"].replace('top_img/', '')
        # feature_file = os.path.join('/data/rensisi/HMCAN/MTTV/data/gossip/region_feature/{}.pkl'.format(img_name))
        # with open(feature_file, mode='rb') as f:
