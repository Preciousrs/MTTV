...
def get_args(parser):
    ...
    parser.add_argument("--bert_model", type=str, default="bert-base-uncased", choices=["bert-base-uncased", "bert-large-uncased", "bert-base-chinese"])
    parser.add_argument("--data_path", type=str, default="/data/rensisi/HMCAN/MTTV/data/fakeddit")
    ...
    parser.add_argument("--savedir", type=str, default="./save_dir_fakeddit/")
    parser.add_argument("--seed", type=int, default=123)
    parser.add_argument("--task", type=str, default="mmimdb", choices=["mmimdb", "vsnli", "food101","gossip","fakeddit", "weibo"])
